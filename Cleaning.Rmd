...
```{r rename columns, filter out continents and change na values for na 1}
...
```{r}
#Graph showing the lowest countries that produces meat from 1960-2018
...
```{r}
#Graph showing the top countries that produces meat from 1960-2018
...
p_countries %>% 
  ...
  ggplot(aes(x=country, y=production, fill=production))+
  geom_col()+
  labs(y="Production", x= "Country",title="Top Countries - Global Meat Production", subtitle ="between 1960 to 2018")
```
...
>>>>>>> d1d88a013717d9aba25a68cb2d54fd3479dfcf2f
